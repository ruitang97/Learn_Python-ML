...
![image-20210713120604743](media/image-20210713120604743.png)

在Python中，我们可以使用`|`来求两个集合的并集：

![image-20210713120713109](media/image-20210713120713109.png)

在Python中，我们可以使用`-`来求两个集合的差集：

![image-20210713120814652](media/image-20210713120814652.png)
